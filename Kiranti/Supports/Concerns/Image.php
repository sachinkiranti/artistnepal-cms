...
trait Image
{
    ...
    public function uploadImageThumbs($image, $imageName, $folder_name, $image_name = null)
    {
        ...
        foreach ($image_dimension as $image_dimension) {
            ...
            $img = \Intervention\Image\Facades\Image::make($image)->resize($image_dimension['width'], $image_dimension['height']);
            // save file as jpg with medium quality
            Storage::disk('public')->put('images'.DIRECTORY_SEPARATOR . $folder_name . DIRECTORY_SEPARATOR . $image_dimension['width'] . '_' . $image_dimension['height'] . '_' . $imageName, $img);
        }
    }
