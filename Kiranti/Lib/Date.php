...
final class Date
{
    ...
    private static $_nep_date = ['year' => '', 'month' => '', 'date' => '', 'day' => '', 'nmonth' => '', 'num_day' => ''];
    private static $_eng_date = ['year' => '', 'month' => '', 'date' => '', 'day' => '', 'emonth' => '', 'num_day' => ''];
    ...
    /**
     * Calculates weather english year is leap year or not.
     *
     * @param int $year
     *
     * @return bool
     ...
     * @return array
     */
    public static function fromADToBS($yy, $mm, $dd)
    {
        ...
        if ($chk !== true) {
            ...
            $numDay = $day;
            static::$_nep_date['year'] = static::convert_to_nepali_number($y);
            static::$_nep_date['month'] = static::convert_to_nepali_number($m);
            static::$_nep_date['date'] = static::convert_to_nepali_number($total_nDays);
            static::$_nep_date['day'] = static::_get_day_of_week($day);
            static::$_nep_date['nmonth'] = static::_get_nepali_month($m);
            static::$_nep_date['num_day'] = static::convert_to_nepali_number($numDay);

            return static::$_nep_date;
        }
    }
     ...
     * @return array
     */
    public static function fromBSToAD($yy, $mm, $dd)
    {
        $def_eyy = 1943;
        $def_emm = 4;
        ...
        if ($chk !== true) {
            ...
            static::$_eng_date['month'] = $m;
            static::$_eng_date['date'] = $total_eDays;
    ...
    {
        return static::convert(date('Y'), date('m'), date('d'));
    }
    ...
    {
        $date = static::fromADToBS($year, $month, $day);
        return sprintf('%s %s %s, %s', $date['date'], $date['nmonth'], $date['year'], $date['day']);
    }
