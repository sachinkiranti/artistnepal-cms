$(function () {
    var WidgetManager = {
        ...
        bind: function () {
            ...
            this.$widgetDroppableArea.on('change', 'select[name=template]', this.previewWidgetTemplate);
            this.$widgetDroppableArea.on('click', '.widget-preview-thumbnail', this.showWidgetOverlay);
            ...
            $(document).on('click', '.update-widget', this.updateWidget);
        ...
        previewWidgetTemplate: function () {
            var widgetPreviewer = $(this).next('.widget-previewer');
            var imagePath = utils.getImagePath('widgets/' + $(this).val() + '.png');
