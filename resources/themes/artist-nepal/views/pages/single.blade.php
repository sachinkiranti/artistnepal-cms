...
@section('promo-banner', $data['post']->getBanner())

@section('promo-container')
    <hr class="line pr__hr__secondary">
    <h2 class="page-title  uk-heading-primary" style="color: white;">{{ ucwords($data['post']->title) }}</h2>
@endsection
                                ...
                                <div class="outer uk-grid uk-grid-large uk-flex uk-grid-stack" data-uk-grid="">
                                    <div class="inner uk-width-expand uk-first-column">
                                        <div class="entry-body">
                                            ...
                                            <p style="text-align: right;"><span style="color: #808080;"><em>updated on: {{ $data['post']->updated_at->format('d/m/Y') }}</em></span></p>
                                        </div>
                                    </div>
                                </div>
