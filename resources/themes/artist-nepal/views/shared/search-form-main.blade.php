<form class="pr__form" action="https://artistnepal.com/listing/">
    <div class="search-box">
        ...
        <div class="search-box__inputs">
            ...
            <select name="eras" id="eras" class="search-box__input mt-5">
                ...
                <option value="pioneer-era-artists">Pioneer Era Artists</option>
                <option value="golden-era-artists">Golden Era Artists</option>
            ...
            <select name="artist_status" id="artist_status"
                ...
                <option value="veteran-legendary">Veteran/Legendary</option>
