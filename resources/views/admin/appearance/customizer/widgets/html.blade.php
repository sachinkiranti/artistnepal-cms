@include('admin.appearance.customizer.widgets.partials.widget-top', [
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12 {{ $errors->has('title')?'has-error':'' }}">
            {!! Form::text('title', null, [ 'class' => 'form-control', 'placeholder' => 'Enter the widget title', ]) !!}
            @if($errors->has('title'))
    ...
    <div class="form-group row">
        <label class="col-sm-12 col-form-label is_required">
            ...
            <small>Html/ facebook likebox/ twitter feeds</small>
        </label>
        <div class="col-sm-12 {{ $errors->has('description')?'has-error':'' }}">
            {!! Form::textarea('description', null, [ 'class' => 'form-control', 'rows' => 10, 'placeholder' => 'Enter the html', ]) !!}
