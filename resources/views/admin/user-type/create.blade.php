...
@section('content')
    @include('admin.user-type.partials.breadcrumb', [ 'title' => 'Create' ])

    <div class="wrapper wrapper-content">
        {!! Form::open(['route' => [ 'admin.user-type.store', $role->id ], 'enctype' => 'multipart/form-data', 'method' => 'post', 'id' => 'userForm']) !!}
        <div class="row">
            <div class="col-lg-8">
                <div class="ibox ">
