    ...
    <div class="col-lg-6" style="padding-top: 30px;">
        ...
        <div class="btn-toolbar pull-right">
            ...
            @if (is_active("admin.{$base}.create") || is_active("admin.{$base}.show") || is_active("admin.{$base}.edit"))
                <a href="{{ route('admin.'.$base.'.index') }}" class="btn btn-sm btn-success pull-right m-t-n-xs mr-3"><i
                        class="fa fa-list"></i><strong> List</strong></a>
            @endif

            @if (is_active("admin.{$base}.show"))
                <a href="{{ route('admin.'.$base.'.edit', $id) }}" class="btn btn-sm btn-success pull-right m-t-n-xs mr-3"><i
                        class="fa fa-edit"></i><strong> Edit </strong></a>
            @endif

            @if (is_active("admin.{$base}.edit"))
                <a href="{{ route('admin.'.$base.'.show', $id) }}" class="btn btn-sm btn-success pull-right m-t-n-xs mr-3"><i
