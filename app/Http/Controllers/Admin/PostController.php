...
class PostController extends BaseController
{
    ...
    public function store(StoreRequest $request)
    {
        ...
        $data = array_filter($request->merge([
            ...
            'disable_facebook_comment' => $request->has('disable_facebook_comment'),
            'disable_disqus_comment' => $request->has('disable_disqus_comment'),
            'disable_site_comment' => $request->has('disable_site_comment'),
            'disable_reaction' => $request->has('disable_reaction'),
            'is_author_visible' => $request->has('is_author_visible'),
